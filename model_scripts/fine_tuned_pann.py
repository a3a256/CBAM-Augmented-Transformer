...
class Cnn14(nn.Module):
    ...
    def forward(self, input, is_training=True, mixup_lambda=None):
        """
        Input: (batch_size, data_length)"""

        waveform = torch.flatten(input, start_dim=1)
        ...
        if is_training and mixup_lambda is not None:
...
def load_fine_tuned_pann(pre_trained_model_path, configuration, audioset = False):
...
if __name__ == "__main__":
    load_fine_tuned_pann(pre_trained_model_path="../pre_trained_models/best_fine_tuned_pann_infant_cry.pth", configuration="../configurations/best_fine_tuned_pann_infant_cry_config.json")