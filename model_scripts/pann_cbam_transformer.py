...
class PANN_CBAM_Former(nn.Module):
    def __init__(self, pre_trained_model, cbam_channels, r, num_layers, input_dim, num_heads, dim_feedforward, out_dim, num_classes, dropout=0.0):
        ...
        self.encoder = TransformerEncoder(num_layers=num_layers, input_dim=input_dim, num_heads=num_heads, dim_feedforward=dim_feedforward, dropout=dropout)
...
def load_pann_cbam_transformer(pre_trained_model_path, configuration):
    ...
    model = PANN_CBAM_Former(pre_trained_model=PANN, **config)
...
if __name__ == "__main__":
    load_pann_cbam_transformer(pre_trained_model_path="../pre_trained_models/best_pann_cbam_transformer_infant_cry.pth", configuration="../configurations/best_pann_cbam_transformer_infant_cry_config.json")